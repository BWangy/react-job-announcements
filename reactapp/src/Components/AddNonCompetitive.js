...
const AddNonCompetitive = () => {
    ...
    const addJob = (e) => {
        ...
        if (
            ...
            formData.restriction.trim() === ''
        ) {
            return;
        }
        
        fetch("https://localhost:7207/api/NonCompetitive", {
            method: "POST",
            body: JSON.stringify({
                desc: "",
        ...
        <>
                ...
                <div className="col-lg-4">
                    <Form noValidate validated={validated}>
                        ...
                        <Form.Group className="mb-4">
                            ...
                            <Form.Control name="restriction" value={formData.restriction} onChange={handleInputChange} as="textarea" rows={5} cols={50} required isInvalid={!validated.restriction}></Form.Control>
                        </Form.Group>
            ...
            <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}>
                <Modal.Header closeButton>
                    <Modal.Title>Non-Competitive Jobs</Modal.Title>
                </Modal.Header>
...
export default AddNonCompetitive;
